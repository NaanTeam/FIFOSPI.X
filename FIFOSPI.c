...
void FIFOSPI2_Setup()
{
    ...
    INTSetVectorSubPriority(INT_SPI_2_VECTOR, INT_SUB_PRIORITY_LEVEL_1);
...
int FIFOSPI2_QueueSend(unsigned char data[], int length)
{
    int i = 0;
...
int FIFOSPI2_QueueRead(unsigned char *readByte)
{
...
void __ISR(_SPI_2_VECTOR, IPL3AUTO)__SPI2Interrupt(void)
{
    //Receive interupt
